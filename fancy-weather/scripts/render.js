function render(data) {
  try {
    ...
    let marker = new mapboxgl.Marker()
      .setLngLat([`${data.weather[0].results[0].geometry.lng}`, `${data.weather[0].results[0].geometry.lat}`])
      .addTo(map);
    ...
    function belar(week1) {
      switch (week1) {
        case 'Воскресенье': week1 = 'Нядзеля'; break;
        case 'Понедельник': week1 = 'Панядзелак'; break;
        case 'Вторник': week1 = 'Аўторак'; break;
        case 'Среда': week1 = 'Серада'; break;
        case 'Четверг': week1 = 'Чацвер'; break;
        case 'Пятница': week1 = 'Пятніца'; break;
        case 'Суббота': week1 = 'Субота'; break;
        default: break;
      }
      weekday = week1;
      return weekday;
    ...
    function engl(week1) {
      switch (week1) {
        case 'Воскресенье': week1 = 'Sunday'; break;
        case 'Понедельник': week1 = 'Monday'; break;
        case 'Вторник': week1 = 'Tuesday'; break;
        case 'Среда': week1 = 'Wednesday'; break;
        case 'Четверг': week1 = 'Thursday'; break;
        case 'Пятница': week1 = 'Friday'; break;
        case 'Суббота': week1 = 'Saturday'; break;
        default: break;
      }
      weekday = week1;
      return weekday;
